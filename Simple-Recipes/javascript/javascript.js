...
//Get the <pan> element that closes the modal
var closeBtn = document.getElementsByClassName("close-btn");

//When the user clicks the recipe button, open the modal and close it after 10 seconds
...
document.getElementById('contactForm').addEventListener('submit',
    function(event){
        ...
        if(!firstName || !lastName || !phone || !message){
            //Checcks if fields have been filled out
